...
impl Packet for ClientboundPacket {
    ...
    pub fn deserialize<R: Read>(r: &mut R, state: &ClientState) -> Result<Self> {
        ...
        &ClientState::Play => {
            ...
            37 => Ok(Entity::deserialize(r)?),
            38 => Ok(EntityRelativeMove::deserialize(r)?),
            39 => Ok(EntityLookRelativeMove::deserialize(r)?),
            40 => Ok(EntityLook::deserialize(r)?),
            41 => Ok(ClientboundVehicleMove::deserialize(r)?),
            42 => Ok(OpenSignEditor::deserialize(r)?),
            43 => Ok(CraftRecipeResponse::deserialize(r)?),
            44 => Ok(PlayerAbilities::deserialize(r)?),
            45 => Ok(CombatEvent::deserialize(r)?),
            46 => Ok(PlayerListItem::deserialize(r)?),
            47 => Ok(PlayerPositionAndLook::deserialize(r)?),
            48 => Ok(UseBed::deserialize(r)?),
            49 => Ok(UnlockRecipes::deserialize(r)?),
            50 => Ok(DestroyEntities::deserialize(r)?),
            51 => Ok(RemoveEntityEffect::deserialize(r)?),
            52 => Ok(ResourcePackSend::deserialize(r)?),
            53 => Ok(Respawn::deserialize(r)?),
            54 => Ok(EntityHeadLook::deserialize(r)?),
            55 => Ok(SelectAdvancementTab::deserialize(r)?),
            56 => Ok(WorldBorder::deserialize(r)?),
            57 => Ok(Camera::deserialize(r)?),
            58 => Ok(ClientboundHeldItemChange::deserialize(r)?),
            59 => Ok(DisplayScoreboard::deserialize(r)?),
            60 => Ok(EntityMetadata::deserialize(r)?),
            61 => Ok(AttachEntity::deserialize(r)?),
            62 => Ok(EntityVelocity::deserialize(r)?),
            63 => Ok(EntityEquipment::deserialize(r)?),
            64 => Ok(SetExperience::deserialize(r)?),
            65 => Ok(UpdateHealth::deserialize(r)?),
            66 => Ok(ScoreboardObjective::deserialize(r)?),
            67 => Ok(SetPassengers::deserialize(r)?),
            68 => Ok(Teams::deserialize(r)?),
            69 => Ok(UpdateScore::deserialize(r)?),
            70 => Ok(SpawnPosition::deserialize(r)?),
            71 => Ok(TimeUpdate::deserialize(r)?),
            72 => Ok(Title::deserialize(r)?),
            73 => Ok(SoundEffect::deserialize(r)?),
            74 => Ok(PlayerListHeaderFooter::deserialize(r)?),
            75 => Ok(CollectItem::deserialize(r)?),
            76 => Ok(EntityTeleport::deserialize(r)?),
            77 => Ok(Advancements::deserialize(r)?),
            78 => Ok(EntityProperties::deserialize(r)?),
            79 => Ok(EntityEffect::deserialize(r)?),
    ...
    pub fn get_id(&self) -> i32 {
        ...
        &ClientboundPacket::Entity(..) => 37,
        &ClientboundPacket::EntityRelativeMove(..) => 38,
        &ClientboundPacket::EntityLookRelativeMove(..) => 39,
        &ClientboundPacket::EntityLook(..) => 40,
        &ClientboundPacket::ClientboundVehicleMove(..) => 41,
        &ClientboundPacket::OpenSignEditor(..) => 42,
        &ClientboundPacket::CraftRecipeResponse(..) => 43,
        &ClientboundPacket::PlayerAbilities(..) => 44,
        &ClientboundPacket::CombatEvent(..) => 45,
        &ClientboundPacket::PlayerListItem(..) => 46,
        &ClientboundPacket::PlayerPositionAndLook(..) => 47,
        &ClientboundPacket::UseBed(..) => 48,
        &ClientboundPacket::UnlockRecipes(..) => 49,
        &ClientboundPacket::DestroyEntities(..) => 50,
        &ClientboundPacket::RemoveEntityEffect(..) => 51,
        &ClientboundPacket::ResourcePackSend(..) => 52,
        &ClientboundPacket::Respawn(..) => 53,
        &ClientboundPacket::EntityHeadLook(..) => 54,
        &ClientboundPacket::SelectAdvancementTab(..) => 55,
        &ClientboundPacket::WorldBorder(..) => 56,
        &ClientboundPacket::Camera(..) => 57,
        &ClientboundPacket::ClientboundHeldItemChange(..) => 58,
        &ClientboundPacket::DisplayScoreboard(..) => 59,
        &ClientboundPacket::EntityMetadata(..) => 60,
        &ClientboundPacket::AttachEntity(..) => 61,
        &ClientboundPacket::EntityVelocity(..) => 62,
        &ClientboundPacket::EntityEquipment(..) => 63,
        &ClientboundPacket::SetExperience(..) => 64,
        &ClientboundPacket::UpdateHealth(..) => 65,
        &ClientboundPacket::ScoreboardObjective(..) => 66,
        &ClientboundPacket::SetPassengers(..) => 67,
        &ClientboundPacket::Teams(..) => 68,
        &ClientboundPacket::UpdateScore(..) => 69,
        &ClientboundPacket::SpawnPosition(..) => 70,
        &ClientboundPacket::TimeUpdate(..) => 71,
        &ClientboundPacket::Title(..) => 72,
        &ClientboundPacket::SoundEffect(..) => 73,
        &ClientboundPacket::PlayerListHeaderFooter(..) => 74,
        &ClientboundPacket::CollectItem(..) => 75,
        &ClientboundPacket::EntityTeleport(..) => 76,
        &ClientboundPacket::Advancements(..) => 77,
        &ClientboundPacket::EntityProperties(..) => 78,
        &ClientboundPacket::EntityEffect(..) => 79,
