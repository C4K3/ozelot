...
impl Packet for ClientboundPacket {
    fn deserialize<R: Read>(r: &mut R, state: &ClientState) -> Result<Self> {
        ...
        &ClientState::Play => {
            ...
            48 => Ok(UnlockRecipes::deserialize(r)?),
            49 => Ok(DestroyEntities::deserialize(r)?),
            50 => Ok(RemoveEntityEffect::deserialize(r)?),
            51 => Ok(ResourcePackSend::deserialize(r)?),
            52 => Ok(Respawn::deserialize(r)?),
            53 => Ok(EntityHeadLook::deserialize(r)?),
            54 => Ok(SelectAdvancementTab::deserialize(r)?),
            55 => Ok(WorldBorder::deserialize(r)?),
            56 => Ok(Camera::deserialize(r)?),
            57 => Ok(ClientboundHeldItemChange::deserialize(r)?),
            58 => Ok(DisplayScoreboard::deserialize(r)?),
            59 => Ok(EntityMetadata::deserialize(r)?),
            60 => Ok(AttachEntity::deserialize(r)?),
            61 => Ok(EntityVelocity::deserialize(r)?),
            62 => Ok(EntityEquipment::deserialize(r)?),
            63 => Ok(SetExperience::deserialize(r)?),
            64 => Ok(UpdateHealth::deserialize(r)?),
            65 => Ok(ScoreboardObjective::deserialize(r)?),
            66 => Ok(SetPassengers::deserialize(r)?),
            67 => Ok(Teams::deserialize(r)?),
            68 => Ok(UpdateScore::deserialize(r)?),
            69 => Ok(SpawnPosition::deserialize(r)?),
            70 => Ok(TimeUpdate::deserialize(r)?),
            71 => Ok(Title::deserialize(r)?),
            72 => Ok(SoundEffect::deserialize(r)?),
            73 => Ok(PlayerListHeaderFooter::deserialize(r)?),
            74 => Ok(CollectItem::deserialize(r)?),
            75 => Ok(EntityTeleport::deserialize(r)?),
            76 => Ok(Advancements::deserialize(r)?),
            77 => Ok(EntityProperties::deserialize(r)?),
            78 => Ok(EntityEffect::deserialize(r)?),
    ...
    fn get_id(&self) -> i32 {
        ...
        &ClientboundPacket::UnlockRecipes(..) => 48,
        &ClientboundPacket::DestroyEntities(..) => 49,
        &ClientboundPacket::RemoveEntityEffect(..) => 50,
        &ClientboundPacket::ResourcePackSend(..) => 51,
        &ClientboundPacket::Respawn(..) => 52,
        &ClientboundPacket::EntityHeadLook(..) => 53,
        &ClientboundPacket::SelectAdvancementTab(..) => 54,
        &ClientboundPacket::WorldBorder(..) => 55,
        &ClientboundPacket::Camera(..) => 56,
        &ClientboundPacket::ClientboundHeldItemChange(..) => 57,
        &ClientboundPacket::DisplayScoreboard(..) => 58,
        &ClientboundPacket::EntityMetadata(..) => 59,
        &ClientboundPacket::AttachEntity(..) => 60,
        &ClientboundPacket::EntityVelocity(..) => 61,
        &ClientboundPacket::EntityEquipment(..) => 62,
        &ClientboundPacket::SetExperience(..) => 63,
        &ClientboundPacket::UpdateHealth(..) => 64,
        &ClientboundPacket::ScoreboardObjective(..) => 65,
        &ClientboundPacket::SetPassengers(..) => 66,
        &ClientboundPacket::Teams(..) => 67,
        &ClientboundPacket::UpdateScore(..) => 68,
        &ClientboundPacket::SpawnPosition(..) => 69,
        &ClientboundPacket::TimeUpdate(..) => 70,
        &ClientboundPacket::Title(..) => 71,
        &ClientboundPacket::SoundEffect(..) => 72,
        &ClientboundPacket::PlayerListHeaderFooter(..) => 73,
        &ClientboundPacket::CollectItem(..) => 74,
        &ClientboundPacket::EntityTeleport(..) => 75,
        &ClientboundPacket::Advancements(..) => 76,
        &ClientboundPacket::EntityProperties(..) => 77,
        &ClientboundPacket::EntityEffect(..) => 78,
